...
@PropertySource(value = "classpath:application.yml", factory = com.productcatalogservice.config.YamlPropertySourceFactory.class)
@ComponentScan(basePackages = "com.productcatalogservice")
